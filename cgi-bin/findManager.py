...
#to find the manager with the same name that the user has inputed 
...
print "</h1>"
print "<h1>"
#to print out all of that information that you found that matches up the specific manager
for name in cursor:
